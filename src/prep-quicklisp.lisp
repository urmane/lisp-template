;;; This file is copied directly from Common Lisp in the Wild, by Wimpie Nortje
;;; Do yourself a favor, go buy the book:
;;; https://www.darkchestnut.com/book-common-lisp-application-deployment/

;;; This should be loaded once at the beginning of an edit/run/debug session:
;;; (load "path/to/project-root/src/prep-quicklisp.lisp")
;;; so ASDF can find your system.  Otherwise, you'd need to do something like
;;; cd ~/common-lisp && ln -s ~/src/hello-world
